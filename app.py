...
df_facturacion_filtrada = (
    df_facturacion_filtrada.sort_values(
...
with tab1:
    ...
    completadas = len(
        df_filtrado[
            df_filtrado["fact_estado"] == "completado"
        ]
    )

    retrasadas = len(
        df_filtrado[
            df_filtrado["fact_estado"] == "retrasado"
        ]
    )

    en_progreso = len(
        df_filtrado[
            df_filtrado["fact_estado"] == "en progreso"
        ]
    )
